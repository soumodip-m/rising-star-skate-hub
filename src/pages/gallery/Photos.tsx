          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-12">
              ...
              <div className="flex gap-4 justify-center">
                <a href="https://www.instagram.com/rsa4sports" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Instagram
                </a>
                <a href="https://www.facebook.com/RSA4U/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Facebook
                </a>
              </div>
            </div>
