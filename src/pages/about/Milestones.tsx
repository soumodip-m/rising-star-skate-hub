...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    description: "28 times world champion Joey Mantia conducted an International Speed coaching camp at Academy",
    icon: Globe,
    image: sagWinners,
  },
  {
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-slate-100">
                Milestones that define Team RSA - Rising Stars Academy
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="relative">
                ...
                {milestones.map((milestone, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`md:grid md:grid-cols-2 md:gap-8 items-center ${isLeft ? "" : "md:flex-row-reverse"}`}
                      >
                        {/* Content */}
                        <div className={`${isLeft ? "md:text-right md:pr-12" : "md:pl-12 md:col-start-2"}`}>
                          <Card
                            className={`${milestone.highlight ? "border-2 border-amber-500 shadow-lg shadow-amber-500/20" : ""} hover-lift`}
                          >
                            <CardContent className="p-6">
                              <div className="flex items-start gap-4 md:flex-row-reverse md:justify-end">
                                <div
                                  className={`${milestone.highlight ? "bg-gradient-to-br from-amber-500 to-orange-600" : "bg-primary/10"} p-3 rounded-lg flex-shrink-0`}
                                >
                                  <Icon className={`h-6 w-6 ${milestone.highlight ? "text-white" : "text-primary"}`} />
                                </div>
                                <div className="flex-1">
                                  <div
                                    className={`${milestone.highlight ? "text-amber-600" : "text-primary"} font-bold text-2xl mb-2 flex items-center gap-2`}
                                  >
                        ...
                        <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 -translate-y-4">
                          <div
                            className={`w-6 h-6 rounded-full border-4 ${milestone.highlight ? "bg-amber-500 border-amber-600 animate-pulse" : "bg-primary border-background"}`}
                          ></div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="group relative overflow-hidden rounded-lg shadow-lg hover-lift">
                <img
                  src={warriorChampionship}
                  alt="Warrior Tournament Championship winners with trophy"
              ...
              <div className="group relative overflow-hidden rounded-lg shadow-lg hover-lift">
                <img
                  src={championTeam}
                  alt="RSA team with 7 championship trophies"
                  className="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-4">
              ...
              <div className="group relative overflow-hidden rounded-lg shadow-lg hover-lift">
                <img
                  src={teamMedals}
                  alt="Team RSA athletes with medals at outdoor event"
                  className="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-4">
                ...
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Unmatched success in Khel Mahakumbh and national competitions
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Building character and discipline in thousands of young athletes
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Alumni excelling in NEET and competitive examinations
                    </p>
                  </CardContent>
                </Card>
              </div>
