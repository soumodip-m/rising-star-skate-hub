    ...
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          ...
          content="Expert speed skating training, inline & quad skating classes for kids. Certified coaches, beginner to advanced programs in Ahmedabad. Book free trial!"
        />
        ...
        <meta
          ...
          content="Expert speed skating training, inline & quad skating classes for kids. Certified coaches, beginner to advanced programs. Book free trial!"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Comprehensive roller skating training program offering inline and quad skating for beginners to advanced competitive athletes",
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Expert roller skating coaching in Ahmedabad - Speed skating training with certified coaches. Inline & quad
              skating classes for kids, beginner to advanced programs.
            </p>
            <div
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-8">
            {achievements.map((item) => (
              <div
                key={item.title}
                className="text-center p-6 bg-card/40 backdrop-blur-sm rounded-lg border hover-lift"
              >
