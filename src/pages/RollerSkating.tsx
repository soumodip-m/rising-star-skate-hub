...
export default function RollerSkating() {
  ...
  const achievements = [
    { title: "State Championships", count: "25+ Medals" },
    { title: "National Qualifiers", count: "15+ Students" },
    { title: "Best Times", count: "Multiple Records" },
    { title: "Years of Excellence", count: "8+ Years" },
  ];
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            We offer both Inline (Speed) and Quad (Artistic) skating programs
          </p>

          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-card p-8 rounded-lg border hover-lift">
              <h3 className="text-2xl font-bold mb-4 text-primary">Inline Skating (Speed)</h3>
            ...
            <div className="bg-card p-8 rounded-lg border hover-lift">
              <h3 className="text-2xl font-bold mb-4 text-secondary">Quad Skating (Artistic)</h3>
              <p className="text-muted-foreground mb-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>Artistic movements and choreography</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5" />
