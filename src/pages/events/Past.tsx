      ...
      <main className="flex-1">
        ...
        <section className="gradient-hero text-white py-20">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Accomplishments in Meida</h1>
            <p className="text-xl">Celebrating our achievements and memorable moments</p>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {pastEvents.map((event, index) => <Card key={index} className="hover-lift overflow-hidden">
