      ...
      <main className="flex-1">
        ...
        <section className="gradient-hero text-white py-20">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl">Join Rising Stars Academy today</p>
          </div>
        </section>
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="basic">Basic - ₹3,000/month</SelectItem>
                        <SelectItem value="standard">Standard - ₹5,000/month</SelectItem>
                        <SelectItem value="premium">Premium - ₹8,000/month</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
